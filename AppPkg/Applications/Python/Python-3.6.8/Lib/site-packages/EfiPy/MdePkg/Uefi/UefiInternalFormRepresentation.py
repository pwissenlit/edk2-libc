...
#
# UefiInternalFormRepresentation.py is free software: you can redistribute it and/or
...
class EFI_IFR_FORM_MAP_VarStoreInfo (Union):
  _pack_   = 1
  _fields_ = [
    ("VarName",   EFI_STRING_ID),
    ("VarOffset", UINT16)
...
class EFI_IFR_FORM_MAP (Structure):
  ...
  _fields_ = [
    ("Header",        EFI_IFR_OP_HEADER),
    ("VarStoreId",    EFI_VARSTORE_ID),
    ("VarStoreInfo",  EFI_IFR_FORM_MAP_VarStoreInfo),
    ("VarStoreType",  UINT8)
  ]
