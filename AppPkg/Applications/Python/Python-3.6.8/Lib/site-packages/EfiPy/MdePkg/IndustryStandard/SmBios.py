...
class MBCE_SYSTEM_RESERVED (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ...
    ("ExtensionByte2Reserved",            UINT8, 3)
  ]
...
class SMBIOS_TABLE_TYPE0 (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ...
    ("ExtendedBiosSize",                        EXTENDED_BIOS_ROM_SIZE)
  ]
...
ProcessorFamilyVideoProcessor        = 0x01F
...
class SMBIOS_TABLE_TYPE4 (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ...
    ("ProcessorManufacture",      SMBIOS_TABLE_STRING),
...
MC_HOST_INTERFACE_PROTOCOL_TYPE               = UINTN

class SMBIOS_TABLE_TYPE42 (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Hdr",                 SMBIOS_STRUCTURE),
    ("InterfaceType",       UINT8),
    ("MCHostInterfaceData", UINT8 * 1)
  ]
