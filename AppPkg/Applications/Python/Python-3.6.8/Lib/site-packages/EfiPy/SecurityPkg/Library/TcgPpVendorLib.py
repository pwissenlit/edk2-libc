...
#
# TcgPpVendorLib.py is free software: you can redistribute it and/or
...
TCG_BIOS_TPM_MANAGEMENT_FLAG_NO_PPI_PROVISION                    = BIT0
TCG_BIOS_TPM_MANAGEMENT_FLAG_NO_PPI_CLEAR                        = BIT1
TCG_BIOS_TPM_MANAGEMENT_FLAG_NO_PPI_MAINTENANCE                  = BIT2
TCG_VENDOR_LIB_FLAG_RESET_TRACK                                  = BIT3
