...
#
# BroadwellMsr.py is free software: you can redistribute it and/or
...
MSR_BROADWELL_IA32_PERF_GLOBAL_STAUS     = 0x0000038E

class MSR_BROADWELL_IA32_PERF_GLOBAL_STAUS_REGISTER_Bits (Structure):
  _fields_ = [
    ("Ovf_PMC0",      UINT32, 1),
    ("Ovf_PMC1",      UINT32, 1),
    ("Ovf_PMC2",      UINT32, 1),
...
class MSR_BROADWELL_IA32_PERF_GLOBAL_STAUS_REGISTER (Union):
  _fields_ = [
    ("Bits",      MSR_BROADWELL_IA32_PERF_GLOBAL_STAUS_REGISTER_Bits),
    ("Uint64",    UINT64)
  ]
