...
#
# Base.py is free software: you can redistribute it and/or modify
...
ENCODE_ERROR    = lambda StatusCode: StatusCode | MAX_BIT
ENCODE_WARNING  = lambda StatusCode: StatusCode
RETURN_ERROR    = lambda StatusCode: True if (StatusCode & MAX_BIT) != 0 else False
...
RETURN_HTTP_ERROR            = ENCODE_ERROR (35)
...
RETURN_WARN_FILE_SYSTEM      = ENCODE_WARNING (6)
...
SIGNATURE_32 = lambda A, B, C, D:             SIGNATURE_16 (A, B)       | (SIGNATURE_16 (C, D) << 16)
SIGNATURE_64 = lambda A, B, C, D, E, F, G, H: SIGNATURE_32 (A, B, C, D) | (SIGNATURE_32 (E, F, G, H) << 32)
