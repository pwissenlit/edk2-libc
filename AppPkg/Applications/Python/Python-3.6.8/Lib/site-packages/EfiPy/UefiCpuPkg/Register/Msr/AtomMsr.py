...
#
# AtomMsr.py is free software: you can redistribute it and/or
...
class MSR_ATOM_PEBS_ENABLE_REGISTER_Bits (Structure):
  _fields_ = [
    ("Enable",    UINT32, 1),
    ("Reserved1", UINT32, 31),
    ("Reserved2", UINT32, 32),
...
class MSR_ATOM_PEBS_ENABLE_REGISTER (Union):
  _fields_ = [
    ("Bits",      MSR_ATOM_PEBS_ENABLE_REGISTER_Bits),
    ("Uint32",    UINT32),
    ("Uint64",    UINT64)
  ]
