...
#
# LocalApic.py is free software: you can redistribute it and/or
...
MSR_IA32_APIC_BASE_ADDRESS              = 0x1B
...
class MSR_IA32_APIC_BASE_Bits (Structure):
  _fields_ = [
    ("Reserved0",     UINT32, 8),
    ("Bsp",           UINT32, 1),
    ("Reserved1",     UINT32, 1),
    ("Extd",          UINT32, 1),
    ("En",            UINT32, 1),
    ("ApicBaseLow",   UINT32, 20),
    ("ApicBaseHigh",  UINT32, 32),
  ]

class MSR_IA32_APIC_BASE (Union):
  _fields_ = [
    ("Bits",      MSR_IA32_APIC_BASE_Bits),
    ("Uint64",    UINT64)
  ]
