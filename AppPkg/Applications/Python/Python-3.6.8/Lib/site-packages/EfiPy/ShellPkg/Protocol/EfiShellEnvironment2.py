...
#
# EfiShellEnvironment2.py is free software: you can redistribute it and/or
...
from EfiPy import *
from EfiPy.MdePkg.Protocol.SimpleFileSystem import EFI_FILE_HANDLE
from EfiPy.MdePkg.Protocol.LoadedImage import EFI_LOADED_IMAGE_PROTOCOL
from EfiPy.MdePkg.Guid.FileInfo import EFI_FILE_INFO
from EfiPy.ShellPkg.Protocol.EfiShellInterface import EFI_SHELL_INTERFACE
...
EFI_SHELL_MAJOR_VER = 0x00000001
EFI_SHELL_MINOR_VER = 0x00000000
...
EFI_OUTPUT_SCROLL   = 0x00000001
EFI_OUTPUT_PAUSE    = 0x00000002
EFI_EXECUTION_BREAK = 0x00000004
...
NEXT_PROTOCOL_INFO = CFUNCTYPE (
  EFI_STATUS,
  PROTOCOL_INFO            #   IN OUT **ProtocolInfo
  )
...
EFI_SHELL_COMPATIBLE_MODE_VER = u"1.1.1"
EFI_SHELL_ENHANCED_MODE_VER   = u"1.1.2"
