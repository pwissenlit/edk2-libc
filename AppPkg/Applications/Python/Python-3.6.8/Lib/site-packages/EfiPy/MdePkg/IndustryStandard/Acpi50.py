...
from EfiPy.MdePkg.IndustryStandard.Acpi40 import *
...
class EFI_ACPI_5_0_GENERIC_ADDRESS_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class EFI_ACPI_5_0_ROOT_SYSTEM_DESCRIPTION_POINTER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Signature",         UINT64),
    ("Checksum",          UINT8),
    ("OemId",             UINT8 * 6),
...
class EFI_ACPI_5_0_COMMON_HEADER (Structure):
  _fields_ = [
    ("Signature", UINT32),
    ("Length",    UINT32)
  ]
...
class EFI_ACPI_5_0_FIRMWARE_ACPI_CONTROL_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Signature",             UINT32),
    ("Length",                UINT32),
...
class EFI_ACPI_5_0_MULTIPLE_APIC_DESCRIPTION_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",            EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_PROCESSOR_LOCAL_APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
...
class EFI_ACPI_5_0_IO_APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                      UINT8),
    ("Length",                    UINT8),
    ("IoApicId",                  UINT8),
...
class EFI_ACPI_5_0_INTERRUPT_SOURCE_OVERRIDE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
    ("Bus",                   UINT8),
...
class EFI_ACPI_5_0_PLATFORM_INTERRUPT_APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT8),
    ("Length",                        UINT8),
    ("Flags",                         UINT16),
...
class EFI_ACPI_5_0_NON_MASKABLE_INTERRUPT_SOURCE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
    ("Flags",                 UINT16),
...
class EFI_ACPI_5_0_LOCAL_APIC_NMI_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
    ("AcpiProcessorId", UINT8),
...
class EFI_ACPI_5_0_LOCAL_APIC_ADDRESS_OVERRIDE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",          UINT8),
    ("Length",        UINT8),
    ("Reserved",      UINT16),
...
class EFI_ACPI_5_0_IO_SAPIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                      UINT8),
    ("Length",                    UINT8),
    ("IoApicId",                  UINT8),
...
class EFI_ACPI_5_0_PROCESSOR_LOCAL_SAPIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",              UINT8),
    ("Length",            UINT8),
    ("AcpiProcessorId",   UINT8),
...
class EFI_ACPI_5_0_PLATFORM_INTERRUPT_SOURCES_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT8),
    ("Length",                        UINT8),
    ("Flags",                         UINT16),
...
class EFI_ACPI_5_0_PROCESSOR_LOCAL_X2APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",              UINT8),
    ("Length",            UINT8),
    ("Reserved",          UINT8 * 2),
...
class EFI_ACPI_5_0_LOCAL_X2APIC_NMI_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",              UINT8),
    ("Length",            UINT8),
    ("Flags",             UINT16),
...
class EFI_ACPI_5_0_SMART_BATTERY_DESCRIPTION_TABLE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",              EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_EMBEDDED_CONTROLLER_BOOT_RESOURCES_TABLE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",    EFI_ACPI_DESCRIPTION_HEADER),
    ("EcControl", EFI_ACPI_5_0_GENERIC_ADDRESS_STRUCTURE),
...
class EFI_ACPI_5_0_SYSTEM_RESOURCE_AFFINITY_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",    EFI_ACPI_DESCRIPTION_HEADER),
    ("Reserved1", UINT32),
    ("Reserved2", UINT64)
...
class EFI_ACPI_5_0_PROCESSOR_LOCAL_APIC_SAPIC_AFFINITY_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
...
class EFI_ACPI_5_0_MEMORY_AFFINITY_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
...
class EFI_ACPI_5_0_PROCESSOR_LOCAL_X2APIC_AFFINITY_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
    ("Reserved1",       UINT8 * 2),
...
class EFI_ACPI_5_0_SYSTEM_LOCALITY_DISTANCE_INFORMATION_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",                    EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_CORRECTED_PLATFORM_ERROR_POLLING_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",    EFI_ACPI_DESCRIPTION_HEADER),
    ("Reserved",  UINT8 * 8)
  ]
...
class EFI_ACPI_5_0_CPEP_PROCESSOR_APIC_SAPIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
    ("ProcessorId",     UINT8),
...
class EFI_ACPI_5_0_MAXIMUM_SYSTEM_CHARACTERISTICS_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",                          EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_MAXIMUM_PROXIMITY_DOMAIN_INFORMATION_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Revision",                  UINT8),
    ("Length",                    UINT8),
...
class EFI_ACPI_5_0_ERROR_BLOCK_STATUS (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class EFI_ACPI_5_0_BOOT_ERROR_REGION_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class EFI_ACPI_5_0_GENERIC_ERROR_DATA_ENTRY_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class EFI_ACPI_5_0_HARDWARE_ERROR_SOURCE_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",            EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_IA32_ARCHITECTURE_MACHINE_CHECK_EXCEPTION_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT16),
    ("SourceId",                      UINT16),
    ("Reserved0",                     UINT8 * 2),
...
class EFI_ACPI_5_0_IA32_ARCHITECTURE_MACHINE_CHECK_ERROR_BANK_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("BankNumber",                    UINT8),
...
class EFI_ACPI_5_0_HARDWARE_ERROR_NOTIFICATION_CONFIGURATION_WRITE_ENABLE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                            UINT16, 1),
...
class EFI_ACPI_5_0_HARDWARE_ERROR_NOTIFICATION_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT8),
    ("Length",                        UINT8),
...
class EFI_ACPI_5_0_IA32_ARCHITECTURE_CORRECTED_MACHINE_CHECK_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT16),
    ("SourceId",                      UINT16),
    ("Reserved0",                     UINT8 * 2),
...
class EFI_ACPI_5_0_IA32_ARCHITECTURE_NMI_ERROR_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT16),
    ("SourceId",                      UINT16),
    ("Reserved0",                     UINT8 * 2),
...
class EFI_ACPI_5_0_PCI_EXPRESS_ROOT_PORT_AER_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                                UINT16),
    ("SourceId",                            UINT16),
    ("Reserved0",                           UINT8 * 2),
...
class EFI_ACPI_5_0_PCI_EXPRESS_DEVICE_AER_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                                UINT16),
    ("SourceId",                            UINT16),
    ("Reserved0",                           UINT8 * 2),
...
class EFI_ACPI_5_0_PCI_EXPRESS_BRIDGE_AER_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                                          UINT16),
    ("SourceId",                                      UINT16),
    ("Reserved0",                                     UINT8 * 2),
...
class EFI_ACPI_5_0_GENERIC_HARDWARE_ERROR_SOURCE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                          UINT16),
    ("SourceId",                      UINT16),
    ...
    ("MaxSectionsPerRecord",          UINT32),
    ("MaxRawDataLength",              UINT32),
    ("ErrorStatusAddress",            EFI_ACPI_5_0_GENERIC_ADDRESS_STRUCTURE),
    ("NotificationStructure",         EFI_ACPI_5_0_HARDWARE_ERROR_NOTIFICATION_STRUCTURE),
    ("ErrorStatusBlockLength",        UINT32)
  ]

class EFI_ACPI_5_0_GENERIC_ERROR_STATUS_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("BlockStatus",     EFI_ACPI_5_0_ERROR_BLOCK_STATUS),
    ("RawDataOffset",   UINT32),
    ("RawDataLength",   UINT32),
...
class EFI_ACPI_5_0_ERROR_RECORD_SERIALIZATION_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",                  EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_ERST_SERIALIZATION_INSTRUCTION_ENTRY (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("SerializationAction", UINT8),
    ("Instruction",         UINT8),
    ("Flags",               UINT8),
    ("Reserved0",           UINT8),
    ("RegisterRegion",      EFI_ACPI_5_0_GENERIC_ADDRESS_STRUCTURE),
    ("Value",               UINT64),
    ("Mask",                UINT64)
  ]

class EFI_ACPI_5_0_ERROR_INJECTION_TABLE_HEADER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",              EFI_ACPI_DESCRIPTION_HEADER),
...
class EFI_ACPI_5_0_EINJ_INJECTION_INSTRUCTION_ENTRY (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class EFI_ACPI_5_0_EINJ_TRIGGER_ACTION_TABLE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("HeaderSize",  UINT32),
    ("Revision",    UINT32),
    ("TableSize",   UINT32),
...
EFI_ACPI_5_0_WINDOWS_ACPI_ENLIGHTENMENT_TABLE_SIGNATURE     = EFI_ACPI_5_0_WINDOWS_ACPI_EMULATED_DEVICES_TABLE_SIGNATURE
