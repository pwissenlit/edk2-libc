...
#
# SdramSpdDdr3.py is free software: you can redistribute it and/or modify
...
class SPD3_MEDIUM_TIMEBASE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
...
class SPD3_BASE_SECTION (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ...
    ("SdramDensityAndBanks Banks",  SPD3_SDRAM_DENSITY_BANKS_STRUCT),
