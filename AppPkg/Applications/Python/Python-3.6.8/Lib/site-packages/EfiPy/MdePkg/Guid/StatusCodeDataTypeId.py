...
#
# StatusCodeDataTypeId.py is free software: you can redistribute it and/or
...
class EFI_STATUS_CODE_EXCEP_EXTENDED_DATA (Union):
  _fields_ = [
    ("DataHeader",  EFI_STATUS_CODE_DATA),
    ("Context",     EFI_STATUS_CODE_EXCEP_SYSTEM_CONTEXT)
  ]

class EFI_STATUS_CODE_START_EXTENDED_DATA (Union):
  _fields_ = [
    ("DataHeader",          EFI_STATUS_CODE_DATA),
...
class EFI_LEGACY_OPROM_EXTENDED_DATA (Union):
  _fields_ = [
    ("DataHeader",    EFI_STATUS_CODE_DATA),
