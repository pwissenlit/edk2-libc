...
#
# Acpi30.py is free software: you can redistribute it and/or
...
from EfiPy.MdePkg.IndustryStandard.Acpi20 import *
...
class EFI_ACPI_3_0_ROOT_SYSTEM_DESCRIPTION_POINTER (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Signature",         UINT64),
    ("Checksum",          UINT8),
    ("OemId",             UINT8 * 6),
...
class EFI_ACPI_3_0_COMMON_HEADER (Structure):
  _fields_ = [
    ("Signature", UINT32),
    ("Length",    UINT32)
  ]
...
class EFI_ACPI_3_0_FIRMWARE_ACPI_CONTROL_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Signature",             UINT32),
    ("Length",                UINT32),
...
class EFI_ACPI_3_0_PROCESSOR_LOCAL_APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
...
class EFI_ACPI_3_0_IO_APIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                      UINT8),
    ("Length",                    UINT8),
    ("IoApicId",                  UINT8),
...
class EFI_ACPI_3_0_INTERRUPT_SOURCE_OVERRIDE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
    ("Bus",                   UINT8),
...
class EFI_ACPI_3_0_NON_MASKABLE_INTERRUPT_SOURCE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
    ("Flags",                 UINT16),
...
class EFI_ACPI_3_0_LOCAL_APIC_NMI_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",            UINT8),
    ("Length",          UINT8),
    ("AcpiProcessorId", UINT8),
...
class EFI_ACPI_3_0_LOCAL_APIC_ADDRESS_OVERRIDE_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",          UINT8),
    ("Length",        UINT8),
    ("Reserved",      UINT16),
...
class EFI_ACPI_3_0_IO_SAPIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                      UINT8),
    ("Length",                    UINT8),
    ("IoApicId",                  UINT8),
...
class EFI_ACPI_3_0_PROCESSOR_LOCAL_SAPIC_STRUCTURE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Type",                  UINT8),
    ("Length",                UINT8),
    ("AcpiProcessorId",       UINT8),
...
class EFI_ACPI_3_0_SMART_BATTERY_DESCRIPTION_TABLE (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Header",              EFI_ACPI_DESCRIPTION_HEADER),
...
EFI_ACPI_3_0_ROOT_SYSTEM_DESCRIPTION_POINTER_SIGNATURE  = SIGNATURE_64('R', 'S', 'D', ' ', 'P', 'T', 'R', ' ')
EFI_ACPI_3_0_MULTIPLE_APIC_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('A', 'P', 'I', 'C')
EFI_ACPI_3_0_DIFFERENTIATED_SYSTEM_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('D', 'S', 'D', 'T')
EFI_ACPI_3_0_EMBEDDED_CONTROLLER_BOOT_RESOURCES_TABLE_SIGNATURE  = SIGNATURE_32('E', 'C', 'D', 'T')
EFI_ACPI_3_0_FIXED_ACPI_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('F', 'A', 'C', 'P')
EFI_ACPI_3_0_FIRMWARE_ACPI_CONTROL_STRUCTURE_SIGNATURE  = SIGNATURE_32('F', 'A', 'C', 'S')
EFI_ACPI_3_0_PERSISTENT_SYSTEM_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('P', 'S', 'D', 'T')
EFI_ACPI_3_0_ROOT_SYSTEM_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('R', 'S', 'D', 'T')
EFI_ACPI_3_0_SMART_BATTERY_SPECIFICATION_TABLE_SIGNATURE  = SIGNATURE_32('S', 'B', 'S', 'T')
EFI_ACPI_3_0_SYSTEM_LOCALITY_INFORMATION_TABLE_SIGNATURE  = SIGNATURE_32('S', 'L', 'I', 'T')
EFI_ACPI_3_0_SYSTEM_RESOURCE_AFFINITY_TABLE_SIGNATURE  = SIGNATURE_32('S', 'R', 'A', 'T')
EFI_ACPI_3_0_SECONDARY_SYSTEM_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('S', 'S', 'D', 'T')
EFI_ACPI_3_0_EXTENDED_SYSTEM_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('X', 'S', 'D', 'T')
EFI_ACPI_3_0_SIMPLE_BOOT_FLAG_TABLE_SIGNATURE  = SIGNATURE_32('B', 'O', 'O', 'T')
EFI_ACPI_3_0_CORRECTED_PLATFORM_ERROR_POLLING_TABLE_SIGNATURE  = SIGNATURE_32('C', 'P', 'E', 'P')
EFI_ACPI_3_0_DEBUG_PORT_TABLE_SIGNATURE  = SIGNATURE_32('D', 'B', 'G', 'P')
EFI_ACPI_3_0_EVENT_TIMER_DESCRIPTION_TABLE_SIGNATURE  = SIGNATURE_32('E', 'T', 'D', 'T')
...
EFI_ACPI_3_0_SERIAL_PORT_CONSOLE_REDIRECTION_TABLE_SIGNATURE  = SIGNATURE_32('S', 'P', 'C', 'R')
EFI_ACPI_3_0_SERVER_PLATFORM_MANAGEMENT_INTERFACE_TABLE_SIGNATURE  = SIGNATURE_32('S', 'P', 'M', 'I')
