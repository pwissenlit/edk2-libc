...
#
# UgaIo.py is free software: you can redistribute it and/or
...
PUGA_DEVICE_TYPE          = POINTER(UGA_DEVICE_TYPE)
...
PUGA_FW_SERVICE_DISPATCH = CFUNCTYPE (
  EFI_STATUS,
  POINTER(UGA_DEVICE),          # IN      pDevice
  POINTER(UGA_IO_REQUEST)       # IN  OUT pIoRequest
  )
