...
#
# CoreMsr.py is free software: you can redistribute it and/or
...
MSR_CORE_ROB_CR_BKUPTMPDR6               = 0x000001E0

class MSR_CORE_ROB_CR_BKUPTMPDR6_REGISTER_Bits (Structure):
  _fields_ = [
    ("Reserved1",   UINT32, 2),
...
class MSR_CORE_ROB_CR_BKUPTMPDR6_REGISTER (Union):
  _fields_ = [
    ("Bits",      MSR_CORE_ROB_CR_BKUPTMPDR6_REGISTER_Bits),
    ("Uint32",    UINT32),
    ("Uint64",    UINT64)
  ]
