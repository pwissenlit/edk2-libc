...
class EFI_PRINT2S_PROTOCOL (Structure):
  pass

UNICODE_VALUE_TO_STRING_S = CFUNCTYPE (
  EFI_STATUS,
  CHAR16,     # IN OUT *Buffer,
  UINTN,      # IN     BufferSize,
  UINTN,      # IN     Flags,
  INT64,      # IN     Value,
  UINTN       # IN     Width
...
ASCII_VALUE_TO_STRING_S = CFUNCTYPE (
  EFI_STATUS,
  CHAR8,      # IN OUT *Buffer,
  UINTN,      # IN     BufferSize,
  UINTN,      # IN     Flags,
...
EFI_PRINT2S_PROTOCOL._fields_ = [
  ("UnicodeBSPrint",            UNICODE_BS_PRINT),
  ("UnicodeSPrint",             UNICODE_S_PRINT),
  ("UnicodeBSPrintAsciiFormat", UNICODE_BS_PRINT_ASCII_FORMAT),
  ("UnicodeSPrintAsciiFormat",  UNICODE_S_PRINT_ASCII_FORMAT),
  ("UnicodeValueToStringS",     UNICODE_VALUE_TO_STRING_S),
  ("AsciiBSPrint",              ASCII_BS_PRINT),
  ("AsciiSPrint",               ASCII_S_PRINT),
  ("AsciiBSPrintUnicodeFormat", ASCII_BS_PRINT_UNICODE_FORMAT),
  ("AsciiSPrintUnicodeFormat",  ASCII_S_PRINT_UNICODE_FORMAT),
  ("AsciiValueToStringS",       ASCII_VALUE_TO_STRING_S),
  ]

gEfiPrint2SProtocolGuid  = \
  EFI_GUID (0xcc252d2, 0xc106, 0x4661, (0xb5, 0xbd, 0x31, 0x47, 0xa4, 0xf8, 0x1f, 0x92))
