...
#
# ProcessorContext.py is free software: you can redistribute it and/or
...
SOFT_DEBUGGER_REGISTER_GDTR0   = 0x09
SOFT_DEBUGGER_REGISTER_GDTR1   = 0x0A
SOFT_DEBUGGER_REGISTER_IDTR0   = 0x0B
SOFT_DEBUGGER_REGISTER_IDTR1   = 0x0C
...
SOFT_DEBUGGER_REGISTER_MAX             = SOFT_DEBUGGER_REGISTER_MM7

SOFT_DEBUGGER_MSR_EFER                 = (0xC0000080)

class DEBUG_DATA_IA32_FX_SAVE_STATE (Structure):
  _pack_   = 1
  _fields_ = [
    ("Fcw",            UINT16),
    ("Fsw",            UINT16),
...
class DEBUG_DATA_IA32_SYSTEM_CONTEXT (Structure):
  _pack_   = 1
  _fields_ = [
    ("ExceptionData",   UINT32),
    ("FxSaveState",     DEBUG_DATA_IA32_FX_SAVE_STATE),
    ("Dr0",             UINT32),
    ("Dr1",             UINT32),
    ("Dr2",             UINT32),
    ("Dr3",             UINT32),
...
class DEBUG_DATA_X64_FX_SAVE_STATE (Structure):
  _pack_   = 1
  _fields_ = [
    ("Fcw",         UINT16  ),
    ("Fsw",         UINT16  ),
    ...
    ("Xmm14",       UINT8 * 16),
    ("Xmm15",       UINT8 * 16),
    ("Reserved11",  UINT8 * (6 * 16)),
    ]

class DEBUG_DATA_X64_SYSTEM_CONTEXT (Structure):
  _pack_   = 1
  _fields_ = [
    ("ExceptionData",   UINT64),
    ("FxSaveState",     DEBUG_DATA_X64_FX_SAVE_STATE),
    ("Dr0",             UINT64),
    ("Dr1",             UINT64),
    ("Dr2",             UINT64),
    ("Dr3",             UINT64),
