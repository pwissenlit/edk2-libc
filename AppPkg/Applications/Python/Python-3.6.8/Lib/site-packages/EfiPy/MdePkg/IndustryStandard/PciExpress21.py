...
class PCI_REG_PCIE_DEVICE_CAPABILITY (EFIPY_INDUSTRY_UNION):
  _fields_ = [
    ("Bits",    PCI_REG_PCIE_DEVICE_CAPABILITY_Bits),
    ("Uint32",  UINT32)
    ]
...
class PCI_REG_PCIE_SLOT_CONTROL_Bits (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("AttentionButtonPressed",      UINT32, 1),
    ("PowerFaultDetected",          UINT32, 1),
    ("MrlSensorChanged",            UINT32, 1),
    ("PresenceDetectChanged",       UINT32, 1),
    ("CommandCompletedInterrupt",   UINT32, 1),
    ("HotPlugInterrupt",            UINT32, 1),
    ("AttentionIndicator",          UINT32, 2),
    ("PowerIndicator",              UINT32, 2),
    ("PowerController",             UINT32, 1),
    ("ElectromechanicalInterlock",  UINT32, 1),
    ("DataLinkLayerStateChanged",   UINT32, 1),
    ("Reserved",                    UINT32, 1),
    ]
...
class PCI_REG_PCIE_LINK_CAPABILITY2_Bits (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("Reserved : 1;         ", UINT32, 1),
    ("LinkSpeedsVector : 7; ", UINT32, 7),
    ("Crosslink : 1;        ", UINT32, 1),
    ("Reserved2 : 23;       ", UINT32, 23),
    ]
...
PCI_EXPRESS_EXTENDED_CAPABILITY_LINK_DECLARATION_GET_LINK_COUNT  = lambda LINK_DECLARATION: cast(((LINK_DECLARATION.ElementSelfDescription) & 0x0000ff00)>>8, UINT8)
...
PCI_EXPRESS_EXTENDED_CAPABILITY_ACS_EXTENDED_GET_EGRES_CONTROL      = lambda ACS_EXTENDED: cast(((ACS_EXTENDED.AcsCapability)&0x00000020), UINT8)
PCI_EXPRESS_EXTENDED_CAPABILITY_ACS_EXTENDED_GET_EGRES_VECTOR_SIZE  = lambda ACS_EXTENDED: cast(((ACS_EXTENDED.AcsCapability)&0x0000FF00), UINT8)
...
PCI_EXPRESS_EXTENDED_CAPABILITY_VENDOR_SPECIFIC_GET_SIZE  = lambda VENDOR: cast(((VENDOR.VendorSpecificHeader)&0xFFF00000)>>20, UINT16)
...
GET_NUMBER_RESIZABLE_BARS  = lambda x: (((x.Capability[0].ResizableBarControl) & 0xE0) >> 5)
...
PCI_EXPRESS_EXTENDED_CAPABILITY_DYNAMIC_POWER_ALLOCATION_GET_SUBSTATE_MAX  = lambda POWER: cast(((POWER.DpaCapability)&0x0000000F), UINT16)
...
GET_TPH_TABLE_SIZE  = lambda x: ((x.TphRequesterCapability & 0x7FF0000)>>16) * sizeof(UINT16)
