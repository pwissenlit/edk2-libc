...
#
# ImageAuthentication.py is free software: you can redistribute it and/or
...
from EfiPy.MdePkg.Protocol  import Hash

gEfiImageSecurityDatabaseGuid  = \
  EFI_GUID (0xd719b2cb, 0x3d3a, 0x4596, ( 0xa3, 0xbc, 0xda, 0xd0, 0xe, 0x67, 0x65, 0x6f ))

EFI_IMAGE_SECURITY_DATABASE       = u"db"
EFI_IMAGE_SECURITY_DATABASE1      = u"dbx"
EFI_IMAGE_SECURITY_DATABASE2      = u"dbt"
...
class EFI_SIGNATURE_LIST (Structure):
  ...
  _fields_ = [
      ...
      # ("Signatures",          EFI_SIGNATURE_DATA * N * SignatureSize)
    ]
