...
EFIERR    = lambda A: ENCODE_ERROR (A)
EFI_ERROR = lambda A: RETURN_ERROR (A)
...
EFI_PAGES_TO_SIZE = lambda Pages: Pages << EFI_PAGE_SHIFT
...
_EFI_IMAGE_MACHINE_TYPE_SUPPORTED_dict = {
    EFIPY_MDE_CPU_IA32    : lambda Machine: Machine == EFI_IMAGE_MACHINE_IA32           or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_IPF     : lambda Machine: Machine == EFI_IMAGE_MACHINE_IA64           or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_X64     : lambda Machine: Machine == EFI_IMAGE_MACHINE_X64            or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_ARM     : lambda Machine: Machine == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_AARCH64 : lambda Machine: Machine == EFI_IMAGE_MACHINE_AARCH64        or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_EBC     : lambda Machine: Machine == EFI_IMAGE_MACHINE_EBC,
}

_EFI_IMAGE_MACHINE_CROSS_TYPE_SUPPORTED_dict = {
    EFIPY_MDE_CPU_IA32    : lambda Machine: Machine == EFI_IMAGE_MACHINE_IA32 or Machine == EFI_IMAGE_MACHINE_EBC,
    EFIPY_MDE_CPU_IPF     : lambda Machine: False,
    EFIPY_MDE_CPU_X64     : lambda Machine: Machine == EFI_IMAGE_MACHINE_IA32,
    EFIPY_MDE_CPU_ARM     : lambda Machine: Machine == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED,
    EFIPY_MDE_CPU_AARCH64 : lambda Machine: False,
    EFIPY_MDE_CPU_EBC     : lambda Machine: False,
}

EFI_IMAGE_MACHINE_TYPE_SUPPORTED        = _EFI_IMAGE_MACHINE_TYPE_SUPPORTED_dict       [EFIPY_MDE_CPU_TYPE]
EFI_IMAGE_MACHINE_CROSS_TYPE_SUPPORTED  = _EFI_IMAGE_MACHINE_CROSS_TYPE_SUPPORTED_dict [EFIPY_MDE_CPU_TYPE]
