...
#
# Pci22.py is free software: you can redistribute it and/or
...
IS_CLASS1     = lambda _p, c:                                 _p.Hdr.ClassCode[2] == (c)
IS_CLASS2     = lambda _p, c, s:    IS_CLASS1 (_p, c)     and _p.Hdr.ClassCode[1] == s
IS_CLASS3     = lambda _p, c, s, p: IS_CLASS2 (_p, c, s)  and _p.Hdr.ClassCode[0] == p

IS_PCI_DISPLAY  = lambda _p: IS_CLASS1 (_p, PCI_CLASS_DISPLAY)
IS_PCI_VGA      = lambda _p: IS_CLASS3 (_p, PCI_CLASS_DISPLAY, PCI_CLASS_DISPLAY_VGA, PCI_IF_VGA_VGA)
IS_PCI_8514     = lambda _p: IS_CLASS3 (_p, PCI_CLASS_DISPLAY, PCI_CLASS_DISPLAY_VGA, PCI_IF_VGA_8514)
IS_PCI_OLD      = lambda _p: IS_CLASS1 (_p, PCI_CLASS_OLD)
IS_PCI_OLD_VGA  = lambda _p: IS_CLASS2 (_p, PCI_CLASS_OLD, PCI_CLASS_OLD_VGA)
IS_PCI_IDE      = lambda _p: IS_CLASS2 (_p, PCI_CLASS_MASS_STORAGE, PCI_CLASS_MASS_STORAGE_IDE)
IS_PCI_SCSI     = lambda _p: IS_CLASS2 (_p, PCI_CLASS_MASS_STORAGE, PCI_CLASS_MASS_STORAGE_SCSI)
IS_PCI_RAID     = lambda _p: IS_CLASS2 (_p, PCI_CLASS_MASS_STORAGE, PCI_CLASS_MASS_STORAGE_RAID)
IS_PCI_LPC      = lambda _p: IS_CLASS2 (_p, PCI_CLASS_BRIDGE, PCI_CLASS_BRIDGE_ISA)
IS_PCI_P2P      = lambda _p: IS_CLASS3 (_p, PCI_CLASS_BRIDGE, PCI_CLASS_BRIDGE_P2P, PCI_IF_BRIDGE_P2P)
IS_PCI_P2P_SUB  = lambda _p: IS_CLASS3 (_p, PCI_CLASS_BRIDGE, PCI_CLASS_BRIDGE_P2P, PCI_IF_BRIDGE_P2P_SUBTRACTIVE)
IS_PCI_16550_SERIAL  = lambda _p: IS_CLASS3 (_p, PCI_CLASS_SCC, PCI_SUBCLASS_SERIAL, PCI_IF_16550)
IS_PCI_USB      = lambda _p: IS_CLASS2 (_p, PCI_CLASS_SERIAL, PCI_CLASS_SERIAL_USB)
...
IS_PCI_BRIDGE     = lambda _p: (_p.Hdr.HeaderType & HEADER_LAYOUT_CODE) == HEADER_TYPE_PCI_TO_PCI_BRIDGE
IS_CARDBUS_BRIDGE = lambda _p: (_p.Hdr.HeaderType & HEADER_LAYOUT_CODE) == HEADER_TYPE_CARDBUS_BRIDGE
IS_PCI_MULTI_FUNC = lambda _p: (_p.Hdr.HeaderType & HEADER_TYPE_MULTI_FUNCTION) == HEADER_TYPE_MULTI_FUNCTION
...
DEVICE_ID_NOCARE    = 0xFFFF

PCI_ACPI_UNUSED     = 0
PCI_BAR_NOCHANGE    = 0
PCI_BAR_OLD_ALIGN   = 0xFFFFFFFFFFFFFFFF
PCI_BAR_EVEN_ALIGN  = 0xFFFFFFFFFFFFFFFE
PCI_BAR_SQUAD_ALIGN = 0xFFFFFFFFFFFFFFFD
PCI_BAR_DQUAD_ALIGN = 0xFFFFFFFFFFFFFFFC
