...
#
# UsbFunctionIo.py is free software: you can redistribute it and/or
...
class EFI_USB_INTERFACE_INFO (Structure):
  _fields_ = [
    ("InterfaceDescriptor",     POINTER(UsbIo.EFI_USB_INTERFACE_DESCRIPTOR)),
    ("EndpointDescriptorTable", POINTER(POINTER(UsbIo.EFI_USB_ENDPOINT_DESCRIPTOR)))
  ]

class EFI_USB_CONFIG_INFO (Structure):
  _fields_ = [
    ("ConfigDescriptor",    POINTER(UsbIo.EFI_USB_CONFIG_DESCRIPTOR)),
    ("InterfaceInfoTable",  POINTER(POINTER(EFI_USB_INTERFACE_INFO)))
  ]

class EFI_USB_DEVICE_INFO (Structure):
  _fields_ = [
    ("DeviceDescriptor",  POINTER(UsbIo.EFI_USB_DEVICE_DESCRIPTOR)),
...
class EFI_USBFN_MESSAGE_PAYLOAD (Union):
  _fields_ = [
    ("udr", UsbIo.EFI_USB_DEVICE_REQUEST),
