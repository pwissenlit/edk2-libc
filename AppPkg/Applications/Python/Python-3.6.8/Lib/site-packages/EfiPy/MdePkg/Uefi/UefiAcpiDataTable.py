...
class EFI_SMM_COMMUNICATION_ACPI_TABLE_2 (Structure):
  _pack_   = 1
  _fields_ = [
    ("UefiSmmCommunicationAcpiTable", EFI_SMM_COMMUNICATION_ACPI_TABLE),
    ("InvocationRegister",            Acpi.EFI_ACPI_6_0_GENERIC_ADDRESS_STRUCTURE),
  ]
