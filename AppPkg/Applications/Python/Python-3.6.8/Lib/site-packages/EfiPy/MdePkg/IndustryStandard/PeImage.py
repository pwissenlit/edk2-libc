...
#
# PeImage.py is free software: you can redistribute it and/or modify
...
EFI_IMAGE_SYM_UNDEFINED = UINT16 (0 ).value
EFI_IMAGE_SYM_ABSOLUTE  = UINT16 (-1).value
EFI_IMAGE_SYM_DEBUG     = UINT16 (-2).value
...
class EFI_IMAGE_THUNK_DATA_u1 (Union):
  _fields_ = [
    ("Function",      UINT32),
    ("Ordinal",       UINT32),
...
class EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u1_s (Structure):
  _fields_ = [
    ("NameOffset",    UINT32, 31),
    ("NameIsString",  UINT32, 1),
  ]

class EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u1 (Union):
  _fields_ = [
    ("s",   EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u1_s),
    ("Id",  UINT32)
  ]

class EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u2_s (Structure):
  _fields_ = [
    ("OffsetToDirectory", UINT32, 31),
    ("DataIsDirectory",   UINT32, 1)
  ]

class EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u2 (Union):
  _fields_ = [
    ("OffsetToData",  UINT32),
    ("s",             EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY_u2_s)
  ]

class EFI_IMAGE_RESOURCE_DIRECTORY_ENTRY (Structure):
  _fields_ = [
