...
#
# HttpUtilities.py is free software: you can redistribute it and/or
...
EFI_HTTP_UTILS_BUILD = CFUNCTYPE (
  ...
  POINTER(POINTER(CHAR8)),              #   IN  *DeleteList[],  OPTIONAL
  UINTN,                                #   IN  AppendCount,
  POINTER(POINTER(EFI_HTTP_HEADER)),    #   IN  *AppendList[],  OPTIONAL
