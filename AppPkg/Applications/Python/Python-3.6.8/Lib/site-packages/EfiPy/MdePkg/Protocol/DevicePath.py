...
#
# DevicePath.py is free software: you can redistribute it and/or
...
from EfiPy.MdePkg.Guid.PcAnsi       import                    \
                                      EFI_PC_ANSI_GUID,       \
                                      EFI_VT_100_GUID,        \
...
from EfiPy.MdePkg.IndustryStandard.Bluetooth  import  BLUETOOTH_ADDRESS
from EfiPy.MdePkg.IndustryStandard.Acpi       import  EFI_ACPI_6_0_NFIT_GUID_RAM_DISK_SUPPORTING_VIRTUAL_DISK_REGION_VOLATILE,    \
...
class EMMC_DEVICE_PATH (EFIPY_DEVICE_PATH_STRUCTURE):
  _fields_ = [
    ("Header",      EFI_DEVICE_PATH_PROTOCOL),
    ("SlotNumber",  UINT8)
    ]
