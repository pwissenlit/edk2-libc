...
#
# EfiShellInterface.py is free software: you can redistribute it and/or
...
from EfiPy.MdePkg.Protocol.SimpleFileSystem import EFI_FILE_PROTOCOL
...
EFI_SHELL_ARG_INFO_TYPES = UINTN
