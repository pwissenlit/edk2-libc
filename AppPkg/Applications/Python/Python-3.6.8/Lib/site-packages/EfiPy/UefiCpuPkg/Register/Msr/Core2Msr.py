...
#
# Core2Msr.py is free software: you can redistribute it and/or
...
MSR_CORE2_BBL_CR_CTL3                    = 0x0000011E

class MSR_CORE2_BBL_CR_CTL3_REGISTER_Bits (Structure):
  _fields_ = [
...
class MSR_CORE2_BBL_CR_CTL3_REGISTER (Union):
  _fields_ = [
    ("Bits",      MSR_CORE2_BBL_CR_CTL3_REGISTER_Bits),
    ("Uint32",    UINT32),
    ("Uint64",    UINT64)
  ]
...
MSR_CORE2_PERF_GLOBAL_STAUS              = 0x0000038E
