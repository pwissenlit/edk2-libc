...
#
# SdramSpdDdr4.py is free software: you can redistribute it and/or modify
...
class SPD4_MANUFACTURER_ID_CODE_Bits (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("ContinuationCount",   UINT8, 7),
    ("ContinuationParity",  UINT8, 1),
    ("LastNonZeroByte",     UINT8, 8),
    ]
...
class SPD4_LRDIMM_DATA_BUFFER_VREFDQ_FOR_DRAM_INTERFACE (EFIPY_INDUSTRY_UNION):
  _fields_ = [
...
class SPD4_NVDIMM_FUNCTION_INTERFACE_DESCRIPTOR_Bits (EFIPY_INDUSTRY_STRUCTURE):
  _fields_ = [
    ("FunctionInterface", UINT8, 5),
    ("FunctionClass",     UINT8, 5),
    ("BlockOffset",       UINT8, 4),
    ("Reserved",          UINT8, 1),
    ("Implemented",       UINT8, 1),
    ]
