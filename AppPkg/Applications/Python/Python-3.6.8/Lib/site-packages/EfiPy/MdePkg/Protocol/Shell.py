...
#
# Shell.py is free software: you can redistribute it and/or
...
EFI_SHELL_FREE_FILE_LIST = CFUNCTYPE (
  EFI_STATUS,
  EFI_SHELL_FILE_INFO                     # IN  **FileList
  )

EFI_SHELL_GET_CUR_DIR = CFUNCTYPE (
  EFI_STATUS,
  CHAR16                     # IN CONST   *FileSystemMapping OPTIONAL
  )
...
EFI_SHELL_REMOVE_DUP_IN_FILE_LIST = CFUNCTYPE (
  EFI_STATUS,
  POINTER(EFI_SHELL_FILE_INFO)  #   IN    **FileList
  )
